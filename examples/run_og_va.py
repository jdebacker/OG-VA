...
def main():
    ...
    base_dir = os.path.join(CUR_DIR, "OG-VA-Example", "OUTPUT_BASELINE")
    reform_dir = os.path.join(CUR_DIR, "OG-VA-Example", "OUTPUT_REFORM")
    ...
    p.tax_func_type = "GS"
    c1 = Calibration(p, estimate_tax_functions=True, client=client)
    # Run model
    ...
    # op.plot_all(
    #     base_dir, reform_dir, os.path.join(CUR_DIR, "OG-VA_example_plots")
    # )
